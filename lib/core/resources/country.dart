...
class Country {
  ...
  @override
  String toString() {
    return 'Country(name: $name, nameTranslations: $nameTranslations, flag: $flag, code: $code, dialCode: $dialCode, regionCode: $regionCode, minLength: $minLength, maxLength: $maxLength)';
  }
}
